---
title: "Notes on EM PCA development"
author: "Kevin Wright"
date: "16 Mar 2019"
---
...
Python code by Stephen Bailey, retrieved 1 Mar 2019 from https://github.com/sbailey/empca.
...
For a complete-data problem (see B1 below), this code gives results identical to R above.Note the `Coeff` matrix does NOT have eigenvalues swept out of the columns.
For the missing-data problem, the results are somewhat different from R.
...
While this is a type of EM algorithm, it is not the algorithm described by Bailey (2012).
