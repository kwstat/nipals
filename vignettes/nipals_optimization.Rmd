...
The `nipals()` function make heavy use of the `crossprod()` and `tcrossprod()` functions, which have been optimized.  Naive coding of the NIPALS algorithm in C could easily be *less* efficient than the R version used in this package.
